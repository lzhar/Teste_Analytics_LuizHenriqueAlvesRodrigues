...
class Dados:
    ...
    def montar_dados(self): 
        ...
        dados_tres = Dados(3, date(2023, 1, 1), produto17, 7)
        dados_quatro = Dados(4, date(2023, 1, 2), produto5, 19)
        dados_cinco = Dados(5, date(2023, 1, 2), produto21, 25)
        dados_seis = Dados(6, date(2023, 1, 3), produto8, 3)
        dados_sete = Dados(7, date(2023, 1, 3), produto14, 44)
        dados_oito = Dados(8, date(2023, 1, 4), produto1, 6)
        dados_nove = Dados(9, date(2023, 1, 4), produto19, 18)
        dados_dez = Dados(10, date(2023, 1, 5), produto7, 9)
        dados_onze = Dados(11, date(2023, 1, 5), produto12, 30)
        dados_doze = Dados(12, date(2023, 1, 6), produto20, 15)
        dados_treze = Dados(13, date(2023, 1, 7), produto4, 21)
        dados_quatorze = Dados(14, date(2023, 1, 7), produto15, 2)
        dados_quinze = Dados(15, date(2023, 1, 8), produto2, 50)
        dados_dezesseis = Dados(16, date(2023, 1, 8), produto9, 33)
        dados_dezessete = Dados(17, date(2023, 1, 9), produto18, 11)
        dados_dezoito = Dados(18, date(2023, 1, 10), produto6, 14)
        dados_dezenove = Dados(19, date(2023, 1, 10), produto11, 20)
        dados_vinte = Dados(20, date(2023, 1, 11), produto13, 5)

        dados_vinte_um = Dados(21, date(2023, 1, 11), produto16, 8)
        dados_vinte_dois = Dados(22, date(2023, 1, 12), produto3, 40)
        dados_vinte_tres = Dados(23, date(2023, 1, 13), produto21, 12)
        dados_vinte_quatro = Dados(24, date(2023, 1, 13), produto7, 28)
        dados_vinte_cinco = Dados(25, date(2023, 1, 14), produto5, 22)
        dados_vinte_seis = Dados(26, date(2023, 1, 15), produto14, 9)
        dados_vinte_sete = Dados(27, date(2023, 1, 15), produto20, 37)
        dados_vinte_oito = Dados(28, date(2023, 1, 16), produto1, 4)
        dados_vinte_nove = Dados(29, date(2023, 1, 16), produto8, 26)
        dados_trinta = Dados(30, date(2023, 1, 17), produto2, 13)
        dados_trinta_um = Dados(31, date(2023, 1, 17), produto19, 31)
        dados_trinta_dois = Dados(32, date(2023, 1, 18), produto6, 2)
        dados_trinta_tres = Dados(33, date(2023, 1, 18), produto10, 44)
        dados_trinta_quatro = Dados(34, date(2023, 1, 19), produto4, 7)
        dados_trinta_cinco = Dados(35, date(2023, 1, 20), produto17, 19)
        dados_trinta_seis = Dados(36, date(2023, 1, 20), produto9, 10)
        dados_trinta_sete = Dados(37, date(2023, 1, 21), produto12, 36)
        dados_trinta_oito = Dados(38, date(2023, 1, 21), produto18, 5)
        dados_trinta_nove = Dados(39, date(2023, 1, 22), produto15, 27)
        dados_quarenta = Dados(40, date(2023, 1, 23), produto11, 1)

        dados_quarenta_um = Dados(41, date(2023, 1, 23), produto13, 48)
        dados_quarenta_dois = Dados(42, date(2023, 1, 24), produto20, 15)
        dados_quarenta_tres = Dados(43, date(2023, 1, 25), produto7, 23)
        dados_quarenta_quatro = Dados(44, date(2023, 1, 25), produto3, 6)
        dados_quarenta_cinco = Dados(45, date(2023, 1, 26), produto16, 35)
        dados_quarenta_seis = Dados(46, date(2023, 1, 27), produto2, 17)
        dados_quarenta_sete = Dados(47, date(2023, 1, 27), produto19, 9)
        dados_quarenta_oito = Dados(48, date(2023, 1, 28), produto8, 41)
        dados_quarenta_nove = Dados(49, date(2023, 1, 29), produto21, 14)
        dados_cinquenta = Dados(50, date(2023, 1, 29), produto14, 8)
        dados_cinquenta_um = Dados(51, date(2023, 1, 30), produto5, 30)
        dados_cinquenta_dois = Dados(52, date(2023, 1, 30), produto9, 4)
        dados_cinquenta_tres = Dados(53, date(2023, 1, 31), produto12, 12)
        dados_cinquenta_quatro = Dados(54, date(2023, 1, 31), produto18, 47)
        dados_cinquenta_cinco = Dados(55, date(2023, 1, 31), produto1, 20)
        dados_cinquenta_seis = Dados(56, date(2023, 1, 31), produto10, 16)
        dados_cinquenta_sete = Dados(57, date(2023, 1, 31), produto4, 7)
        dados_cinquenta_oito = Dados(58, date(2023, 1, 31), produto15, 29)
        dados_cinquenta_nove = Dados(59, date(2023, 1, 31), produto6, 3)
        dados_sessenta = Dados(60, date(2023, 1, 31), produto13, 10)
        
        dados_sessenta_e_um = Dados(61, date(2023, 2, 1), produto5, 14)
        dados_sessenta_e_dois = Dados(62, date(2023, 2, 1), produto17, 8)
        dados_sessenta_e_tres = Dados(63, date(2023, 2, 1), produto3, 22)
        dados_sessenta_e_quatro = Dados(64, date(2023, 2, 2), produto12, 19)
        dados_sessenta_e_cinco = Dados(65, date(2023, 2, 2), produto21, 31)
        dados_sessenta_e_seis = Dados(66, date(2023, 2, 3), produto1, 5)
        dados_sessenta_e_sete = Dados(67, date(2023, 2, 3), produto8, 12)
        dados_sessenta_e_oito = Dados(68, date(2023, 2, 3), produto14, 28)
        dados_sessenta_e_nove = Dados(69, date(2023, 2, 4), produto19, 7)
        dados_setenta = Dados(70, date(2023, 2, 4), produto2, 24)
        dados_setenta_e_um = Dados(71, date(2023, 2, 5), produto9, 11)
        dados_setenta_e_dois = Dados(72, date(2023, 2, 5), produto6, 16)
        dados_setenta_e_tres = Dados(73, date(2023, 2, 6), produto20, 21)
        dados_setenta_e_quatro = Dados(74, date(2023, 2, 6), produto4, 9)
        dados_setenta_e_cinco = Dados(75, date(2023, 2, 7), produto11, 33)
        dados_setenta_e_seis = Dados(76, date(2023, 2, 7), produto13, 4)
        dados_setenta_e_sete = Dados(77, date(2023, 2, 8), produto7, 18)
        dados_setenta_e_oito = Dados(78, date(2023, 2, 8), produto15, 13)
        dados_setenta_e_nove = Dados(79, date(2023, 2, 9), produto18, 27)

        dados_oitenta = Dados(80, date(2023, 2, 9), produto16, 6)
        dados_oitenta_e_um = Dados(81, date(2023, 2, 10), produto5, 29)
        dados_oitenta_e_dois = Dados(82, date(2023, 2, 10), produto21, 10)
        dados_oitenta_e_tres = Dados(83, date(2023, 2, 11), produto2, 22)
        dados_oitenta_e_quatro = Dados(84, date(2023, 2, 11), produto12, 17)
        dados_oitenta_e_cinco = Dados(85, date(2023, 2, 12), produto8, 8)
        dados_oitenta_e_seis = Dados(86, date(2023, 2, 12), produto14, 25)
        dados_oitenta_e_sete = Dados(87, date(2023, 2, 13), produto3, 12)
        dados_oitenta_e_oito = Dados(88, date(2023, 2, 13), produto6, 19)
        dados_oitenta_e_nove = Dados(89, date(2023, 2, 14), produto20, 15)
        dados_noventa = Dados(90, date(2023, 2, 14), produto1, 23)
        dados_noventa_e_um = Dados(91, date(2023, 2, 15), produto9, 7)
        dados_noventa_e_dois = Dados(92, date(2023, 2, 15), produto18, 32)
        dados_noventa_e_tres = Dados(93, date(2023, 2, 16), produto7, 5)
        dados_noventa_e_quatro = Dados(94, date(2023, 2, 16), produto4, 14)
        dados_noventa_e_cinco = Dados(95, date(2023, 2, 17), produto13, 26)
        dados_noventa_e_seis = Dados(96, date(2023, 2, 17), produto16, 9)
        dados_noventa_e_sete = Dados(97, date(2023, 2, 18), produto11, 21)
        dados_noventa_e_oito = Dados(98, date(2023, 2, 18), produto19, 11)
        dados_noventa_e_nove = Dados(99, date(2023, 2, 19), produto15, 30)
        dados_cem = Dados(100, date(2023, 2, 19), produto10, 8)

        dados_cento_e_um = Dados(101, date(2023, 2, 20), produto2, 17)
        dados_cento_e_dois = Dados(102, date(2023, 2, 20), produto21, 4)
        dados_cento_e_tres = Dados(103, date(2023, 2, 21), produto12, 28)
        dados_cento_e_quatro = Dados(104, date(2023, 2, 21), produto5, 13)
        dados_cento_e_cinco = Dados(105, date(2023, 2, 22), produto8, 16)
        dados_cento_e_seis = Dados(106, date(2023, 2, 22), produto17, 6)
        dados_cento_e_sete = Dados(107, date(2023, 2, 23), produto3, 24)
        dados_cento_e_oito = Dados(108, date(2023, 2, 23), produto20, 12)
        dados_cento_e_nove = Dados(109, date(2023, 2, 24), produto6, 7)
        dados_cento_e_dez = Dados(110, date(2023, 2, 24), produto19, 20)
        dados_cento_e_onze = Dados(111, date(2023, 2, 25), produto11, 10)
        dados_cento_e_doze = Dados(112, date(2023, 2, 25), produto1, 31)
        dados_cento_e_treze = Dados(113, date(2023, 2, 26), produto9, 15)
        dados_cento_e_quatorze = Dados(114, date(2023, 2, 26), produto14, 22)
        dados_cento_e_quinze = Dados(115, date(2023, 2, 27), produto4, 8)
        dados_cento_e_dezesseis = Dados(116, date(2023, 2, 27), produto7, 19)
        dados_cento_e_dezessete = Dados(117, date(2023, 2, 28), produto2, 11)
        dados_cento_e_dezoito = Dados(118, date(2023, 2, 28), produto21, 26)
        dados_cento_e_dezenove = Dados(119, date(2023, 2, 28), produto13, 5)
        dados_cento_e_vinte = Dados(120, date(2023, 2, 28), produto12, 18)

        dados_cento_e_vinte_e_um = Dados(121, date(2023, 3, 1), produto7, 12)
        dados_cento_e_vinte_e_dois = Dados(122, date(2023, 3, 1), produto19, 25)
        dados_cento_e_vinte_e_tres = Dados(123, date(2023, 3, 2), produto2, 7)
        dados_cento_e_vinte_e_quatro = Dados(124, date(2023, 3, 2), produto15, 18)
        dados_cento_e_vinte_e_cinco = Dados(125, date(2023, 3, 3), produto11, 30)
        dados_cento_e_vinte_e_seis = Dados(126, date(2023, 3, 3), produto4, 9)
        dados_cento_e_vinte_e_sete = Dados(127, date(2023, 3, 3), produto8, 22)
        dados_cento_e_vinte_e_oito = Dados(128, date(2023, 3, 4), produto21, 15)
        dados_cento_e_vinte_e_nove = Dados(129, date(2023, 3, 4), produto5, 31)
        dados_cento_e_trinta = Dados(130, date(2023, 3, 5), produto16, 11)
        dados_cento_e_trinta_e_um = Dados(131, date(2023, 3, 5), produto3, 24)
        dados_cento_e_trinta_e_dois = Dados(132, date(2023, 3, 6), produto9, 6)
        dados_cento_e_trinta_e_tres = Dados(133, date(2023, 3, 6), produto20, 20)
        dados_cento_e_trinta_e_quatro = Dados(134, date(2023, 3, 7), produto12, 14)
        dados_cento_e_trinta_e_cinco = Dados(135, date(2023, 3, 7), produto6, 27)
        dados_cento_e_trinta_e_seis = Dados(136, date(2023, 3, 8), produto14, 5)
        dados_cento_e_trinta_e_sete = Dados(137, date(2023, 3, 8), produto1, 19)
        dados_cento_e_trinta_e_oito = Dados(138, date(2023, 3, 9), produto18, 8)
        dados_cento_e_trinta_e_nove = Dados(139, date(2023, 3, 9), produto13, 21)

        dados_cento_e_quarenta = Dados(140, date(2023, 3, 10), produto10, 13)
        dados_cento_e_quarenta_e_um = Dados(141, date(2023, 3, 10), produto2, 30)
        dados_cento_e_quarenta_e_dois = Dados(142, date(2023, 3, 11), produto7, 7)
        dados_cento_e_quarenta_e_tres = Dados(143, date(2023, 3, 11), produto21, 26)
        dados_cento_e_quarenta_e_quatro = Dados(144, date(2023, 3, 12), produto5, 10)
        dados_cento_e_quarenta_e_cinco = Dados(145, date(2023, 3, 12), produto17, 29)
        dados_cento_e_quarenta_e_seis = Dados(146, date(2023, 3, 13), produto3, 12)
        dados_cento_e_quarenta_e_sete = Dados(147, date(2023, 3, 13), produto9, 22)
        dados_cento_e_quarenta_e_oito = Dados(148, date(2023, 3, 14), produto8, 3)
        dados_cento_e_quarenta_e_nove = Dados(149, date(2023, 3, 14), produto20, 24)
        dados_cento_e_cinquenta = Dados(150, date(2023, 3, 15), produto6, 9)
        dados_cento_e_cinquenta_e_um = Dados(151, date(2023, 3, 15), produto12, 31)
        dados_cento_e_cinquenta_e_dois = Dados(152, date(2023, 3, 16), produto4, 16)
        dados_cento_e_cinquenta_e_tres = Dados(153, date(2023, 3, 16), produto15, 5)
        dados_cento_e_cinquenta_e_quatro = Dados(154, date(2023, 3, 17), produto11, 27)
        dados_cento_e_cinquenta_e_cinco = Dados(155, date(2023, 3, 17), produto19, 6)
        dados_cento_e_cinquenta_e_seis = Dados(156, date(2023, 3, 18), produto1, 19)
        dados_cento_e_cinquenta_e_sete = Dados(157, date(2023, 3, 18), produto18, 10)
        dados_cento_e_cinquenta_e_oito = Dados(158, date(2023, 3, 19), produto14, 23)
        dados_cento_e_cinquenta_e_nove = Dados(159, date(2023, 3, 19), produto16, 12)
        
        dados_cento_e_sessenta = Dados(160, date(2023, 3, 20), produto7, 29)
        dados_cento_e_sessenta_e_um = Dados(161, date(2023, 3, 20), produto12, 4)
        dados_cento_e_sessenta_e_dois = Dados(162, date(2023, 3, 21), produto3, 21)
        dados_cento_e_sessenta_e_tres = Dados(163, date(2023, 3, 21), produto19, 8)
        dados_cento_e_sessenta_e_quatro = Dados(164, date(2023, 3, 22), produto5, 18)
        dados_cento_e_sessenta_e_cinco = Dados(165, date(2023, 3, 22), produto8, 5)
        dados_cento_e_sessenta_e_seis = Dados(166, date(2023, 3, 23), produto2, 27)
        dados_cento_e_sessenta_e_sete = Dados(167, date(2023, 3, 23), produto14, 14)
        dados_cento_e_sessenta_e_oito = Dados(168, date(2023, 3, 24), produto11, 22)
        dados_cento_e_sessenta_e_nove = Dados(169, date(2023, 3, 24), produto6, 7)
        dados_cento_e_setenta = Dados(170, date(2023, 3, 25), produto21, 30)
        dados_cento_e_setenta_e_um = Dados(171, date(2023, 3, 25), produto1, 11)
        dados_cento_e_setenta_e_dois = Dados(172, date(2023, 3, 26), produto17, 19)
        dados_cento_e_setenta_e_tres = Dados(173, date(2023, 3, 26), produto4, 6)
        dados_cento_e_setenta_e_quatro = Dados(174, date(2023, 3, 27), produto13, 23)
        dados_cento_e_setenta_e_cinco = Dados(175, date(2023, 3, 27), produto9, 9)
        dados_cento_e_setenta_e_seis = Dados(176, date(2023, 3, 28), produto3, 26)
        dados_cento_e_setenta_e_sete = Dados(177, date(2023, 3, 28), produto7, 13)
        dados_cento_e_setenta_e_oito = Dados(178, date(2023, 3, 29), produto5, 18)
        dados_cento_e_setenta_e_nove = Dados(179, date(2023, 3, 29), produto10, 4)
        dados_cento_e_oitenta = Dados(180, date(2023, 3, 30), produto16, 28)

        dados_cento_e_oitenta_e_um = Dados(181, date(2023, 4, 1), produto2, 14)
        dados_cento_e_oitenta_e_dois = Dados(182, date(2023, 4, 1), produto8, 27)
        dados_cento_e_oitenta_e_tres = Dados(183, date(2023, 4, 2), produto11, 9)
        dados_cento_e_oitenta_e_quatro = Dados(184, date(2023, 4, 2), produto15, 21)
        dados_cento_e_oitenta_e_cinco = Dados(185, date(2023, 4, 3), produto3, 5)
        dados_cento_e_oitenta_e_seis = Dados(186, date(2023, 4, 3), produto6, 18)
        dados_cento_e_oitenta_e_sete = Dados(187, date(2023, 4, 3), produto19, 24)
        dados_cento_e_oitenta_e_oito = Dados(188, date(2023, 4, 4), produto1, 11)
        dados_cento_e_oitenta_e_nove = Dados(189, date(2023, 4, 4), produto21, 30)
        dados_cento_e_noventa = Dados(190, date(2023, 4, 5), produto4, 7)
        dados_cento_e_noventa_e_um = Dados(191, date(2023, 4, 5), produto12, 25)
        dados_cento_e_noventa_e_dois = Dados(192, date(2023, 4, 6), produto14, 12)
        dados_cento_e_noventa_e_tres = Dados(193, date(2023, 4, 6), produto8, 28)
        dados_cento_e_noventa_e_quatro = Dados(194, date(2023, 4, 7), produto2, 4)
        dados_cento_e_noventa_e_cinco = Dados(195, date(2023, 4, 7), produto5, 17)
        dados_cento_e_noventa_e_seis = Dados(196, date(2023, 4, 8), produto9, 22)
        dados_cento_e_noventa_e_sete = Dados(197, date(2023, 4, 8), produto18, 8)
        dados_cento_e_noventa_e_oito = Dados(198, date(2023, 4, 9), produto13, 19)
        dados_cento_e_noventa_e_nove = Dados(199, date(2023, 4, 9), produto7, 6)

        dados_duzentos = Dados(200, date(2023, 4, 10), produto16, 26)
        dados_duzentos_e_um = Dados(201, date(2023, 4, 10), produto3, 10)
        dados_duzentos_e_dois = Dados(202, date(2023, 4, 11), produto1, 14)
        dados_duzentos_e_tres = Dados(203, date(2023, 4, 11), produto17, 29)
        dados_duzentos_e_quatro = Dados(204, date(2023, 4, 12), produto6, 3)
        dados_duzentos_e_cinco = Dados(205, date(2023, 4, 12), produto9, 21)
        dados_duzentos_e_seis = Dados(206, date(2023, 4, 13), produto20, 7)
        dados_duzentos_e_sete = Dados(207, date(2023, 4, 13), produto15, 24)
        dados_duzentos_e_oito = Dados(208, date(2023, 4, 14), produto2, 5)
        dados_duzentos_e_nove = Dados(209, date(2023, 4, 14), produto4, 20)
        dados_duzentos_e_dez = Dados(210, date(2023, 4, 15), produto11, 12)
        dados_duzentos_e_onze = Dados(211, date(2023, 4, 15), produto7, 27)
        dados_duzentos_e_doze = Dados(212, date(2023, 4, 16), produto14, 8)
        dados_duzentos_e_treze = Dados(213, date(2023, 4, 16), produto5, 23)
        dados_duzentos_e_quatorze = Dados(214, date(2023, 4, 17), produto18, 16)
        dados_duzentos_e_quinze = Dados(215, date(2023, 4, 17), produto12, 30)
        dados_duzentos_e_dezesseis = Dados(216, date(2023, 4, 18), produto19, 4)
        dados_duzentos_e_dezessete = Dados(217, date(2023, 4, 18), produto21, 18)
        dados_duzentos_e_dezoito = Dados(218, date(2023, 4, 19), produto8, 11)
        dados_duzentos_e_dezenove = Dados(219, date(2023, 4, 19), produto13, 28)
        
        dados_duzentos_e_vinte = Dados(220, date(2023, 4, 20), produto6, 9)
        dados_duzentos_e_vinte_e_um = Dados(221, date(2023, 4, 20), produto17, 26)
        dados_duzentos_e_vinte_e_dois = Dados(222, date(2023, 4, 21), produto3, 15)
        dados_duzentos_e_vinte_e_tres = Dados(223, date(2023, 4, 21), produto10, 19)
        dados_duzentos_e_vinte_e_quatro = Dados(224, date(2023, 4, 22), produto15, 7)
        dados_duzentos_e_vinte_e_cinco = Dados(225, date(2023, 4, 22), produto2, 23)
        dados_duzentos_e_vinte_e_seis = Dados(226, date(2023, 4, 23), produto12, 6)
        dados_duzentos_e_vinte_e_sete = Dados(227, date(2023, 4, 23), produto18, 25)
        dados_duzentos_e_vinte_e_oito = Dados(228, date(2023, 4, 24), produto5, 13)
        dados_duzentos_e_vinte_e_nove = Dados(229, date(2023, 4, 24), produto21, 30)
        dados_duzentos_e_trinta = Dados(230, date(2023, 4, 25), produto11, 8)
        dados_duzentos_e_trinta_e_um = Dados(231, date(2023, 4, 25), produto4, 17)
        dados_duzentos_e_trinta_e_dois = Dados(232, date(2023, 4, 26), produto7, 22)
        dados_duzentos_e_trinta_e_tres = Dados(233, date(2023, 4, 26), produto1, 10)
        dados_duzentos_e_trinta_e_quatro = Dados(234, date(2023, 4, 27), produto16, 27)
        dados_duzentos_e_trinta_e_cinco = Dados(235, date(2023, 4, 27), produto14, 12)
        dados_duzentos_e_trinta_e_seis = Dados(236, date(2023, 4, 28), produto19, 20)
        dados_duzentos_e_trinta_e_sete = Dados(237, date(2023, 4, 28), produto9, 5)
        dados_duzentos_e_trinta_e_oito = Dados(238, date(2023, 4, 29), produto3, 29)
        dados_duzentos_e_trinta_e_nove = Dados(239, date(2023, 4, 29), produto13, 14)
        dados_duzentos_e_quarenta = Dados(240, date(2023, 4, 29), produto8, 11)

        dados_duzentos_e_quarenta_e_um = Dados(241, date(2023, 5, 1), produto20, 16)
        dados_duzentos_e_quarenta_e_dois = Dados(242, date(2023, 5, 1), produto2, 28)
        dados_duzentos_e_quarenta_e_tres = Dados(243, date(2023, 5, 2), produto7, 9)
        dados_duzentos_e_quarenta_e_quatro = Dados(244, date(2023, 5, 2), produto11, 25)
        dados_duzentos_e_quarenta_e_cinco = Dados(245, date(2023, 5, 3), produto1, 12)
        dados_duzentos_e_quarenta_e_seis = Dados(246, date(2023, 5, 3), produto18, 19)
        dados_duzentos_e_quarenta_e_sete = Dados(247, date(2023, 5, 4), produto16, 27)
        dados_duzentos_e_quarenta_e_oito = Dados(248, date(2023, 5, 4), produto3, 8)
        dados_duzentos_e_quarenta_e_nove = Dados(249, date(2023, 5, 5), produto21, 30)
        dados_duzentos_e_cinquenta = Dados(250, date(2023, 5, 5), produto5, 11)
        dados_duzentos_e_cinquenta_e_um = Dados(251, date(2023, 5, 6), produto10, 24)
        dados_duzentos_e_cinquenta_e_dois = Dados(252, date(2023, 5, 6), produto8, 7)
        dados_duzentos_e_cinquenta_e_tres = Dados(253, date(2023, 5, 7), produto14, 22)
        dados_duzentos_e_cinquenta_e_quatro = Dados(254, date(2023, 5, 7), produto6, 14)
        dados_duzentos_e_cinquenta_e_cinco = Dados(255, date(2023, 5, 8), produto12, 18)
        dados_duzentos_e_cinquenta_e_seis = Dados(256, date(2023, 5, 8), produto17, 29)
        dados_duzentos_e_cinquenta_e_sete = Dados(257, date(2023, 5, 9), produto1, 5)
        dados_duzentos_e_cinquenta_e_oito = Dados(258, date(2023, 5, 9), produto15, 20)
        dados_duzentos_e_cinquenta_e_nove = Dados(259, date(2023, 5, 10), produto9, 15)

        dados_duzentos_e_sessenta = Dados(260, date(2023, 5, 10), produto19, 26)
        dados_duzentos_e_sessenta_e_um = Dados(261, date(2023, 5, 11), produto5, 13)
        dados_duzentos_e_sessenta_e_dois = Dados(262, date(2023, 5, 11), produto12, 21)
        dados_duzentos_e_sessenta_e_tres = Dados(263, date(2023, 5, 12), produto8, 30)
        dados_duzentos_e_sessenta_e_quatro = Dados(264, date(2023, 5, 12), produto3, 6)
        dados_duzentos_e_sessenta_e_cinco = Dados(265, date(2023, 5, 13), produto21, 19)
        dados_duzentos_e_sessenta_e_seis = Dados(266, date(2023, 5, 13), produto7, 9)
        dados_duzentos_e_sessenta_e_sete = Dados(267, date(2023, 5, 14), produto14, 24)
        dados_duzentos_e_sessenta_e_oito = Dados(268, date(2023, 5, 14), produto1, 11)
        dados_duzentos_e_sessenta_e_nove = Dados(269, date(2023, 5, 15), produto9, 17)
        dados_duzentos_e_setenta = Dados(270, date(2023, 5, 15), produto16, 28)
        dados_duzentos_e_setenta_e_um = Dados(271, date(2023, 5, 16), produto2, 7)
        dados_duzentos_e_setenta_e_dois = Dados(272, date(2023, 5, 16), produto19, 23)
        dados_duzentos_e_setenta_e_tres = Dados(273, date(2023, 5, 17), produto6, 16)
        dados_duzentos_e_setenta_e_quatro = Dados(274, date(2023, 5, 17), produto11, 27)
        dados_duzentos_e_setenta_e_cinco = Dados(275, date(2023, 5, 18), produto4, 4)
        dados_duzentos_e_setenta_e_seis = Dados(276, date(2023, 5, 18), produto18, 22)
        ...
        dados_duzentos_e_setenta_e_nove = Dados(279, date(2023, 5, 20), produto10, 6)

        dados_duzentos_e_oitenta = Dados(280, date(2023, 5, 20), produto20, 25)
        dados_duzentos_e_oitenta_e_um = Dados(281, date(2023, 5, 21), produto8, 12)
        dados_duzentos_e_oitenta_e_dois = Dados(282, date(2023, 5, 21), produto3, 18)
        dados_duzentos_e_oitenta_e_tres = Dados(283, date(2023, 5, 22), produto5, 29)
        dados_duzentos_e_oitenta_e_quatro = Dados(284, date(2023, 5, 22), produto12, 9)
        dados_duzentos_e_oitenta_e_cinco = Dados(285, date(2023, 5, 23), produto7, 15)
        dados_duzentos_e_oitenta_e_seis = Dados(286, date(2023, 5, 23), produto2, 20)
        dados_duzentos_e_oitenta_e_sete = Dados(287, date(2023, 5, 24), produto14, 8)
        dados_duzentos_e_oitenta_e_oito = Dados(288, date(2023, 5, 24), produto9, 27)
        dados_duzentos_e_oitenta_e_nove = Dados(289, date(2023, 5, 25), produto16, 13)
        dados_duzentos_e_noventa = Dados(290, date(2023, 5, 25), produto6, 22)
        dados_duzentos_e_noventa_e_um = Dados(291, date(2023, 5, 26), produto1, 18)
        dados_duzentos_e_noventa_e_dois = Dados(292, date(2023, 5, 26), produto11, 6)
        dados_duzentos_e_noventa_e_tres = Dados(293, date(2023, 5, 27), produto21, 28)
        dados_duzentos_e_noventa_e_quatro = Dados(294, date(2023, 5, 27), produto4, 10)
        dados_duzentos_e_noventa_e_cinco = Dados(295, date(2023, 5, 28), produto15, 19)
        dados_duzentos_e_noventa_e_seis = Dados(296, date(2023, 5, 28), produto13, 25)
        dados_duzentos_e_noventa_e_sete = Dados(297, date(2023, 5, 29), produto18, 30)
        dados_duzentos_e_noventa_e_oito = Dados(298, date(2023, 5, 30), produto10, 7)
        ...
        dados_trezentos_e_um = Dados(301, date(2023, 6, 1), produto6, 19)
        dados_trezentos_e_dois = Dados(302, date(2023, 6, 1), produto2, 9)
        dados_trezentos_e_tres = Dados(303, date(2023, 6, 2), produto19, 24)
        dados_trezentos_e_quatro = Dados(304, date(2023, 6, 2), produto11, 15)
        dados_trezentos_e_cinco = Dados(305, date(2023, 6, 3), produto7, 27)
        dados_trezentos_e_seis = Dados(306, date(2023, 6, 3), produto14, 8)
        dados_trezentos_e_sete = Dados(307, date(2023, 6, 4), produto3, 21)
        dados_trezentos_e_oito = Dados(308, date(2023, 6, 4), produto16, 12)
        dados_trezentos_e_nove = Dados(309, date(2023, 6, 5), produto20, 29)
        dados_trezentos_e_dez = Dados(310, date(2023, 6, 5), produto5, 16)
        dados_trezentos_e_onze = Dados(311, date(2023, 6, 6), produto9, 10)
        dados_trezentos_e_doze = Dados(312, date(2023, 6, 6), produto1, 23)
        dados_trezentos_e_treze = Dados(313, date(2023, 6, 7), produto12, 6)
        dados_trezentos_e_quatorze = Dados(314, date(2023, 6, 7), produto8, 18)
        dados_trezentos_e_quinze = Dados(315, date(2023, 6, 8), produto4, 25)
        dados_trezentos_e_dezesseis = Dados(316, date(2023, 6, 8), produto21, 14)
        dados_trezentos_e_dezessete = Dados(317, date(2023, 6, 9), produto13, 28)
        dados_trezentos_e_dezoito = Dados(318, date(2023, 6, 9), produto15, 7)
        dados_trezentos_e_dezenove = Dados(319, date(2023, 6, 10), produto17, 20)

        dados_trezentos_e_vinte = Dados(320, date(2023, 6, 10), produto6, 11)
        dados_trezentos_e_vinte_e_um = Dados(321, date(2023, 6, 11), produto3, 30)
        dados_trezentos_e_vinte_e_dois = Dados(322, date(2023, 6, 11), produto18, 9)
        dados_trezentos_e_vinte_e_tres = Dados(323, date(2023, 6, 12), produto2, 17)
        dados_trezentos_e_vinte_e_quatro = Dados(324, date(2023, 6, 12), produto7, 5)
        dados_trezentos_e_vinte_e_cinco = Dados(325, date(2023, 6, 13), produto14, 22)
        dados_trezentos_e_vinte_e_seis = Dados(326, date(2023, 6, 13), produto9, 13)
        dados_trezentos_e_vinte_e_sete = Dados(327, date(2023, 6, 14), produto5, 27)
        dados_trezentos_e_vinte_e_oito = Dados(328, date(2023, 6, 14), produto12, 6)
        dados_trezentos_e_vinte_e_nove = Dados(329, date(2023, 6, 15), produto10, 19)
        dados_trezentos_e_trinta = Dados(330, date(2023, 6, 15), produto1, 14)
        dados_trezentos_e_trinta_e_um = Dados(331, date(2023, 6, 16), produto8, 8)
        dados_trezentos_e_trinta_e_dois = Dados(332, date(2023, 6, 16), produto20, 25)
        dados_trezentos_e_trinta_e_tres = Dados(333, date(2023, 6, 17), produto4, 18)
        dados_trezentos_e_trinta_e_quatro = Dados(334, date(2023, 6, 17), produto19, 30)
        dados_trezentos_e_trinta_e_cinco = Dados(335, date(2023, 6, 18), produto6, 12)
        dados_trezentos_e_trinta_e_seis = Dados(336, date(2023, 6, 18), produto15, 21)
        dados_trezentos_e_trinta_e_sete = Dados(337, date(2023, 6, 19), produto11, 9)
        dados_trezentos_e_trinta_e_oito = Dados(338, date(2023, 6, 19), produto3, 26)
        dados_trezentos_e_trinta_e_nove = Dados(339, date(2023, 6, 20), produto13, 7)

        dados_trezentos_e_quarenta = Dados(340, date(2023, 6, 20), produto16, 15)
        dados_trezentos_e_quarenta_e_um = Dados(341, date(2023, 6, 21), produto2, 28)
        dados_trezentos_e_quarenta_e_dois = Dados(342, date(2023, 6, 21), produto8, 11)
        dados_trezentos_e_quarenta_e_tres = Dados(343, date(2023, 6, 22), produto12, 24)
        dados_trezentos_e_quarenta_e_quatro = Dados(344, date(2023, 6, 22), produto21, 10)
        dados_trezentos_e_quarenta_e_cinco = Dados(345, date(2023, 6, 23), produto7, 18)
        dados_trezentos_e_quarenta_e_seis = Dados(346, date(2023, 6, 23), produto4, 5)
        dados_trezentos_e_quarenta_e_sete = Dados(347, date(2023, 6, 24), produto14, 22)
        dados_trezentos_e_quarenta_e_oito = Dados(348, date(2023, 6, 24), produto10, 14)
        dados_trezentos_e_quarenta_e_nove = Dados(349, date(2023, 6, 25), produto18, 30)
        dados_trezentos_e_cinquenta = Dados(350, date(2023, 6, 25), produto1, 16)
        dados_trezentos_e_cinquenta_e_um = Dados(351, date(2023, 6, 26), produto11, 20)
        dados_trezentos_e_cinquenta_e_dois = Dados(352, date(2023, 6, 26), produto6, 6)
        dados_trezentos_e_cinquenta_e_tres = Dados(353, date(2023, 6, 27), produto19, 23)
        dados_trezentos_e_cinquenta_e_quatro = Dados(354, date(2023, 6, 27), produto3, 19)
        dados_trezentos_e_cinquenta_e_cinco = Dados(355, date(2023, 6, 28), produto8, 13)
        dados_trezentos_e_cinquenta_e_seis = Dados(356, date(2023, 6, 28), produto15, 29)
        dados_trezentos_e_cinquenta_e_sete = Dados(357, date(2023, 6, 29), produto1, 17)
        dados_trezentos_e_cinquenta_e_oito = Dados(358, date(2023, 6, 29), produto13, 9)
        dados_trezentos_e_cinquenta_e_nove = Dados(359, date(2023, 6, 30), produto21, 26)
        dados_trezentos_e_sessenta = Dados(360, date(2023, 6, 30), produto4, 12)

        dados_trezentos_e_sessenta_e_um = Dados(361, date(2023, 7, 1), produto7, 14)
        dados_trezentos_e_sessenta_e_dois = Dados(362, date(2023, 7, 1), produto10, 27)
        dados_trezentos_e_sessenta_e_tres = Dados(363, date(2023, 7, 2), produto2, 10)
        dados_trezentos_e_sessenta_e_quatro = Dados(364, date(2023, 7, 2), produto18, 22)
        dados_trezentos_e_sessenta_e_cinco = Dados(365, date(2023, 7, 3), produto5, 30)
        dados_trezentos_e_sessenta_e_seis = Dados(366, date(2023, 7, 3), produto12, 18)
        dados_trezentos_e_sessenta_e_sete = Dados(367, date(2023, 7, 4), produto9, 7)
        dados_trezentos_e_sessenta_e_oito = Dados(368, date(2023, 7, 4), produto16, 25)
        dados_trezentos_e_sessenta_e_nove = Dados(369, date(2023, 7, 5), produto20, 13)
        dados_trezentos_e_setenta = Dados(370, date(2023, 7, 5), produto14, 19)
        dados_trezentos_e_setenta_e_um = Dados(371, date(2023, 7, 6), produto8, 21)
        dados_trezentos_e_setenta_e_dois = Dados(372, date(2023, 7, 6), produto17, 9)
        dados_trezentos_e_setenta_e_tres = Dados(373, date(2023, 7, 7), produto6, 28)
        dados_trezentos_e_setenta_e_quatro = Dados(374, date(2023, 7, 7), produto3, 15)
        dados_trezentos_e_setenta_e_cinco = Dados(375, date(2023, 7, 8), produto11, 11)
        dados_trezentos_e_setenta_e_seis = Dados(376, date(2023, 7, 8), produto1, 23)
        dados_trezentos_e_setenta_e_sete = Dados(377, date(2023, 7, 9), produto9, 29)
        dados_trezentos_e_setenta_e_oito = Dados(378, date(2023, 7, 9), produto21, 17)
        dados_trezentos_e_setenta_e_nove = Dados(379, date(2023, 7, 10), produto15, 8)

        dados_trezentos_e_oitenta = Dados(380, date(2023, 7, 10), produto5, 26)
        dados_trezentos_e_oitenta_e_um = Dados(381, date(2023, 7, 11), produto2, 20)
        dados_trezentos_e_oitenta_e_dois = Dados(382, date(2023, 7, 11), produto13, 12)
        dados_trezentos_e_oitenta_e_tres = Dados(383, date(2023, 7, 12), produto4, 24)
        dados_trezentos_e_oitenta_e_quatro = Dados(384, date(2023, 7, 12), produto16, 7)
        dados_trezentos_e_oitenta_e_cinco = Dados(385, date(2023, 7, 13), produto10, 18)
        dados_trezentos_e_oitenta_e_seis = Dados(386, date(2023, 7, 13), produto12, 30)
        dados_trezentos_e_oitenta_e_sete = Dados(387, date(2023, 7, 14), produto7, 16)
        dados_trezentos_e_oitenta_e_oito = Dados(388, date(2023, 7, 14), produto19, 5)
        dados_trezentos_e_oitenta_e_nove = Dados(389, date(2023, 7, 15), produto6, 22)
        dados_trezentos_e_noventa = Dados(390, date(2023, 7, 15), produto3, 28)
        dados_trezentos_e_noventa_e_um = Dados(391, date(2023, 7, 16), produto21, 9)
        dados_trezentos_e_noventa_e_dois = Dados(392, date(2023, 7, 16), produto1, 25)
        dados_trezentos_e_noventa_e_tres = Dados(393, date(2023, 7, 17), produto8, 13)
        dados_trezentos_e_noventa_e_quatro = Dados(394, date(2023, 7, 17), produto14, 21)
        dados_trezentos_e_noventa_e_cinco = Dados(395, date(2023, 7, 18), produto9, 15)
        dados_trezentos_e_noventa_e_seis = Dados(396, date(2023, 7, 18), produto2, 10)
        dados_trezentos_e_noventa_e_sete = Dados(397, date(2023, 7, 19), produto17, 27)
        dados_trezentos_e_noventa_e_oito = Dados(398, date(2023, 7, 19), produto5, 19)
        dados_trezentos_e_noventa_e_nove = Dados(399, date(2023, 7, 20), produto11, 30)

        dados_quatrocentos = Dados(400, date(2023, 7, 20), produto20, 14)
        dados_quatrocentos_e_um = Dados(401, date(2023, 7, 21), produto7, 11)
        dados_quatrocentos_e_dois = Dados(402, date(2023, 7, 21), produto12, 22)
        dados_quatrocentos_e_tres = Dados(403, date(2023, 7, 22), produto3, 29)
        dados_quatrocentos_e_quatro = Dados(404, date(2023, 7, 22), produto9, 17)
        dados_quatrocentos_e_cinco = Dados(405, date(2023, 7, 23), produto14, 13)
        dados_quatrocentos_e_seis = Dados(406, date(2023, 7, 23), produto16, 26)
        dados_quatrocentos_e_sete = Dados(407, date(2023, 7, 24), produto5, 18)
        dados_quatrocentos_e_oito = Dados(408, date(2023, 7, 24), produto19, 6)
        ...
        dados_quatrocentos_e_onze = Dados(411, date(2023, 7, 26), produto8, 30)
        dados_quatrocentos_e_doze = Dados(412, date(2023, 7, 26), produto6, 15)
        dados_quatrocentos_e_treze = Dados(413, date(2023, 7, 27), produto11, 19)
        dados_quatrocentos_e_quatorze = Dados(414, date(2023, 7, 27), produto13, 8)
        dados_quatrocentos_e_quinze = Dados(415, date(2023, 7, 28), produto1, 21)
        dados_quatrocentos_e_dezesseis = Dados(416, date(2023, 7, 28), produto15, 25)
        dados_quatrocentos_e_dezessete = Dados(417, date(2023, 7, 29), produto4, 12)
        dados_quatrocentos_e_dezoito = Dados(418, date(2023, 7, 29), produto18, 7)
        dados_quatrocentos_e_dezenove = Dados(419, date(2023, 7, 29), produto10, 20)
        dados_quatrocentos_e_vinte = Dados(420, date(2023, 7, 29), produto3, 16)

        dados_quatrocentos_e_vinte_e_um = Dados(421, date(2023, 8, 1), produto5, 18)
        dados_quatrocentos_e_vinte_e_dois = Dados(422, date(2023, 8, 1), produto7, 26)
        dados_quatrocentos_e_vinte_e_tres = Dados(423, date(2023, 8, 2), produto9, 14)
        dados_quatrocentos_e_vinte_e_quatro = Dados(424, date(2023, 8, 2), produto11, 29)
        dados_quatrocentos_e_vinte_e_cinco = Dados(425, date(2023, 8, 3), produto2, 9)
        dados_quatrocentos_e_vinte_e_seis = Dados(426, date(2023, 8, 3), produto13, 23)
        dados_quatrocentos_e_vinte_e_sete = Dados(427, date(2023, 8, 4), produto6, 12)
        dados_quatrocentos_e_vinte_e_oito = Dados(428, date(2023, 8, 4), produto17, 20)
        dados_quatrocentos_e_vinte_e_nove = Dados(429, date(2023, 8, 5), produto12, 7)
        dados_quatrocentos_e_trinta = Dados(430, date(2023, 8, 5), produto1, 27)
        dados_quatrocentos_e_trinta_e_um = Dados(431, date(2023, 8, 6), produto8, 16)
        dados_quatrocentos_e_trinta_e_dois = Dados(432, date(2023, 8, 6), produto3, 21)
        dados_quatrocentos_e_trinta_e_tres = Dados(433, date(2023, 8, 7), produto14, 10)
        dados_quatrocentos_e_trinta_e_quatro = Dados(434, date(2023, 8, 7), produto19, 18)
        dados_quatrocentos_e_trinta_e_cinco = Dados(435, date(2023, 8, 8), produto5, 25)
        dados_quatrocentos_e_trinta_e_seis = Dados(436, date(2023, 8, 8), produto15, 13)
        dados_quatrocentos_e_trinta_e_sete = Dados(437, date(2023, 8, 9), produto20, 30)
        dados_quatrocentos_e_trinta_e_oito = Dados(438, date(2023, 8, 9), produto10, 15)
        dados_quatrocentos_e_trinta_e_nove = Dados(439, date(2023, 8, 10), produto16, 11)

        dados_quatrocentos_e_quarenta = Dados(440, date(2023, 8, 10), produto4, 24)
        dados_quatrocentos_e_quarenta_e_um = Dados(441, date(2023, 8, 11), produto18, 19)
        dados_quatrocentos_e_quarenta_e_dois = Dados(442, date(2023, 8, 11), produto6, 27)
        dados_quatrocentos_e_quarenta_e_tres = Dados(443, date(2023, 8, 12), produto9, 8)
        dados_quatrocentos_e_quarenta_e_quatro = Dados(444, date(2023, 8, 12), produto11, 22)
        dados_quatrocentos_e_quarenta_e_cinco = Dados(445, date(2023, 8, 13), produto1, 17)
        dados_quatrocentos_e_quarenta_e_seis = Dados(446, date(2023, 8, 13), produto13, 30)
        dados_quatrocentos_e_quarenta_e_sete = Dados(447, date(2023, 8, 14), produto7, 6)
        dados_quatrocentos_e_quarenta_e_oito = Dados(448, date(2023, 8, 14), produto15, 20)
        dados_quatrocentos_e_quarenta_e_nove = Dados(449, date(2023, 8, 15), produto12, 28)
        dados_quatrocentos_e_cinquenta = Dados(450, date(2023, 8, 15), produto2, 12)
        dados_quatrocentos_e_cinquenta_e_um = Dados(451, date(2023, 8, 16), produto4, 23)
        dados_quatrocentos_e_cinquenta_e_dois = Dados(452, date(2023, 8, 16), produto6, 14)
        dados_quatrocentos_e_cinquenta_e_tres = Dados(453, date(2023, 8, 17), produto8, 26)
        dados_quatrocentos_e_cinquenta_e_quatro = Dados(454, date(2023, 8, 17), produto10, 19)
        dados_quatrocentos_e_cinquenta_e_cinco = Dados(455, date(2023, 8, 18), produto12, 10)
        dados_quatrocentos_e_cinquenta_e_seis = Dados(456, date(2023, 8, 18), produto14, 29)
        dados_quatrocentos_e_cinquenta_e_sete = Dados(457, date(2023, 8, 19), produto16, 16)
        dados_quatrocentos_e_cinquenta_e_oito = Dados(458, date(2023, 8, 19), produto18, 7)
        dados_quatrocentos_e_cinquenta_e_nove = Dados(459, date(2023, 8, 20), produto20, 21)

        dados_quatrocentos_e_sessenta = Dados(460, date(2023, 8, 20), produto2, 9)
        dados_quatrocentos_e_sessenta_e_um = Dados(461, date(2023, 8, 21), produto3, 24)
        dados_quatrocentos_e_sessenta_e_dois = Dados(462, date(2023, 8, 21), produto5, 15)
        dados_quatrocentos_e_sessenta_e_tres = Dados(463, date(2023, 8, 22), produto7, 30)
        dados_quatrocentos_e_sessenta_e_quatro = Dados(464, date(2023, 8, 22), produto9, 12)
        dados_quatrocentos_e_sessenta_e_cinco = Dados(465, date(2023, 8, 23), produto11, 27)
        dados_quatrocentos_e_sessenta_e_seis = Dados(466, date(2023, 8, 23), produto13, 18)
        dados_quatrocentos_e_sessenta_e_sete = Dados(467, date(2023, 8, 24), produto15, 5)
        dados_quatrocentos_e_sessenta_e_oito = Dados(468, date(2023, 8, 24), produto17, 25)
        dados_quatrocentos_e_sessenta_e_nove = Dados(469, date(2023, 8, 25), produto19, 13)
        dados_quatrocentos_e_setenta = Dados(470, date(2023, 8, 25), produto1, 19)
        dados_quatrocentos_e_setenta_e_um = Dados(471, date(2023, 8, 26), produto4, 21)
        dados_quatrocentos_e_setenta_e_dois = Dados(472, date(2023, 8, 26), produto6, 7)
        dados_quatrocentos_e_setenta_e_tres = Dados(473, date(2023, 8, 27), produto8, 24)
        dados_quatrocentos_e_setenta_e_quatro = Dados(474, date(2023, 8, 27), produto10, 16)
        dados_quatrocentos_e_setenta_e_cinco = Dados(475, date(2023, 8, 28), produto12, 30)
        dados_quatrocentos_e_setenta_e_seis = Dados(476, date(2023, 8, 28), produto14, 12)
        dados_quatrocentos_e_setenta_e_sete = Dados(477, date(2023, 8, 29), produto16, 18)
        dados_quatrocentos_e_setenta_e_oito = Dados(478, date(2023, 8, 29), produto18, 27)
        dados_quatrocentos_e_setenta_e_nove = Dados(479, date(2023, 8, 30), produto20, 14)
        ...
        dados_quatrocentos_e_noventa_e_um = Dados(491, date(2023, 9, 6), produto4, 16)
        dados_quatrocentos_e_noventa_e_dois = Dados(492, date(2023, 9, 6), produto6, 21)
        dados_quatrocentos_e_noventa_e_tres = Dados(493, date(2023, 9, 7), produto8, 9)
        dados_quatrocentos_e_noventa_e_quatro = Dados(494, date(2023, 9, 7), produto10, 20)
        dados_quatrocentos_e_noventa_e_cinco = Dados(495, date(2023, 9, 8), produto12, 26)
        dados_quatrocentos_e_noventa_e_seis = Dados(496, date(2023, 9, 8), produto14, 15)
        dados_quatrocentos_e_noventa_e_sete = Dados(497, date(2023, 9, 9), produto16, 19)
        dados_quatrocentos_e_noventa_e_oito = Dados(498, date(2023, 9, 9), produto18, 7)
        dados_quatrocentos_e_noventa_e_nove = Dados(499, date(2023, 9, 10), produto20, 23)
    ...
    def montar_csv(self):
        ...
        df_todos.to_csv("data_clean.csv", index=False)
